...
router.post('/',
    check('required-FIRSTNAME').exists().withMessage('first name is required'),
    ...
    check('required-zipcode').exists().withMessage('postal code is required').isPostalCode('US').withMessage('not a valid US postal code'),
    ...
    check('required-highschool-graduation').exists().withMessage('high school year of graduation required').isNumeric().withMessage('high school graduation must be a number').isAfter('2018').withMessage('high school graduation should be after 2018'),
