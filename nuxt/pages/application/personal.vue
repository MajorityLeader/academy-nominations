  ...
  methods: {
    async back() {
      await this.$axios.$patch(
        `/api/applications/personal/${this.$route.query.a}`,
        this.form
      )
